...
# :set/:jbind/:config-* commands without having to write a config.py
# file.
#
# Documentation:
...
# Type: Font
c.fonts.completion.entry = '20pt "Source Code Pro"'

# Font used for the debugging console.
# Type: Font
c.fonts.debug_console = '20pt "Source Code Pro"'
...
# Type: Font
c.fonts.statusbar = '20pt "Source Code Pro"'
...
config.bind('j', 'scroll-px 0 200')   # scroll down faster
config.bind('k', 'scroll-px 0 -200')  # scroll up faster

...
#v::RunOrFocusApp("Visual Studio Code", "Code.exe","C:\Users\WALTON\AppData\Local\Programs\Microsoft VS Code\Code.exe")
#f::RunOrFocusApp("File Explorer", "explorer.exe", "explorer.exe")
#t::RunOrFocusApp("Windows Terminal", "WindowsTerminal.exe", "wt.exe")
#b::RunOrFocusApp("", "chrome.exe", "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe")
